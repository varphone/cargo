...
pub struct CargoBuildConfig {
    ...
    pub native_cc: Option<ConfigRelativePath>,
    pub native_cxx: Option<ConfigRelativePath>,
    pub native_ar: Option<ConfigRelativePath>,
    pub native_cflags: Option<StringList>,
    pub native_cppflags: Option<StringList>,
    pub native_cxxflags: Option<StringList>,
    pub native_ldflags: Option<StringList>,
